...
<head>
    ...
    <!-- Bootstrap CSS -->
    <!-- 3.3.7 compiled and minified CSS & JS -->
    <!-- Offline -->
    ...
    <div class="container">
        ...
        <div class="content">
                ...
                if (isset($_POST['save'])) {
                    ...
                    if ($update) {
                        ...
                        echo '<div class="alert alert-danger alert-dismissable">
                                <button type="button" class="close" data-dismiss="alert" aria-hidden="true"> &times;</button>Error, no se pudo guardar los datos
                              </div>';
                    }
                }
            ...
            <form class="form-horizontal" action="" method="post">
                ...
                <!-- END form group LUGAR DE NACIMIENTO -->
